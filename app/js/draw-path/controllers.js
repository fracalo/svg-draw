...
.controller('DrawCtrl',['$scope', '$filter' , '$timeout','drawService', 'drawPathAttr', 'drawVectorAttr',
  function($scope, $filter, $timeout, drawService, drawPathAttr, drawVectorAttr) {
  var tmpAttr, tmpArr;
  var drw = this;

}])

.controller('DrawEventsCtrl', function($scope, $element, $attrs, $transclude, $rootScope, drawService){
        var tollerance = 20;
